#!/usr/bin/env python3
"""
Frito-Lay Pallet Logistics Optimizer - Vercel Deployment
                    ...
                    dbc.Card([
                        dbc.CardBody([
                            html.Ol([
                                ...
                                html.Li([
                                    html.Strong("Run Locally for Full Features: "),
                                    "Clone from GitHub to use file upload and route recalculation features"
                                ]),
                                html.Li([
                                    html.Strong("Analyze Results: "),
                                    "Review cost savings, efficiency improvements, and route details in the dashboard"
                                ])
                            ])
                        ])
